...
entities.game.MainGroup.load = function(world) {
    ...
    var arch3 = world.createArchetype(game.Akeome, this.Component, ut.Core2D.LayerSorting, ut.Core2D.Sprite2DRenderer, ut.Core2D.Sprite2DRendererOptions, ut.Core2D.TransformLocalPosition, ut.Core2D.TransformLocalRotation, ut.Core2D.TransformLocalScale, ut.Core2D.TransformNode, ut.layers.Default)
    ...
    c17.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/bg_natural_sougen');
    ...
    c24.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/osyougatsu_akemashite_omedetou');
    ...
    c32.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/bg_natural_sougen');
